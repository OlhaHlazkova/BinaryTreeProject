...
namespace BinaryTreeLibrary
{
    ...
    public class BinTree
    {
        ...
        private void Insert(long data, BinTree node, BinTree parent)
        {
            ...
            if (node.Data > data)
            {
                if (node.Left == null) node.Left = new BinTree();
                Insert(data, node.Left, node);
            }
            else
            {
                if (node.Right == null) node.Right = new BinTree();
        ...
        /// <param name="parent">Родительский узел</param>
        private void Insert(BinTree data, BinTree node, BinTree parent)
        {
        ...
        /// <returns></returns>
        private BinSide? MeForParent(BinTree node)
        {
        ...
        public void Remove(BinTree node)
        {
            if (node == null) return;
        ...
        /// <returns></returns>
        public BinTree Find(long data, BinTree node)
        {
        ...
        /// <returns></returns>
        private long CountElements(BinTree node)
        {
            long count = 1;
            if (node.Right != null)
            {
    ...
    {
        public static void Print(BinTree node)
        {
            if (node != null)
            {
                if (node.Parent == null)
